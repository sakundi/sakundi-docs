...
Varios gobiernos, incluido el de Costa Rica, ofrecen un avanzado sistema de identidad digital (Firma Digital) que permite a los residentes o entidades firmar documentos con una identidad digital validada por el Banco Central como Autoridad Certificadora (CA) y autenticarse en diversos sitios web y servicios públicos o privados. Zikuani, un proyecto de Sakundi, es un protocolo de conocimiento cero (Zero Knowledge Proofs) que permite a las personas probar su identidad de una manera que preserva la privacidad, hoy en día ya sea con una credencial de Firma Digital (inicialmente de Costa Rica) o con un pasaporte biométrico (chip NFC, ICAO 9303) — con soporte para el estándar de licencia de conducir móvil (mDL, ISO/IEC 18013-5) planeado como siguiente paso. Proporciona un conjunto de herramientas para generar y verificar pruebas, autenticar usuarios y realizar verificaciones de pruebas tanto fuera como dentro de la blockchain.
